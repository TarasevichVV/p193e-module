                    ...
                    stage('Sab2') {
                        container('centos') {
                            ...
                            sh """
                                ...
                                kubectl patch deploy shanchar-deploy -n shanchar --patch="{'spec':{'template':{'spec':{'containers':[{'name':'shanchar-deploy','nexus-dock.k8s.playpit.by:80/helloworld-shanchar:$BUILD_NUMBER'}]}}}}"
                                sleep 5
                                kubectl get ns
