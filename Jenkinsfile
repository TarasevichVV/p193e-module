...
//            sh "ls $JENKINS_HOME/workspace/mntlab-ci-pipeline/EPBYMINW9146"
        ...
        stage ('Packaging and Publishing results') {
            parallel(
                ...
                'Create tar.gz': {
                    sh 'tar -xvzf script.tar.gz; ls ; tar -czf "pipeline-ayanchuk-$BUILD_NUMBER.tar.gz"  output.txt -C helloworld-project/helloworld-ws/target helloworld-ws.war -C /var/jenkins_home/workspace/EPBYMINW9146/mntlab-ci-dsl Jenkinsfile'
